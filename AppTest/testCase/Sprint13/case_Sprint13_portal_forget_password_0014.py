...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("查看是否跳转至首页")
        Common.wait(self, 5)
        text_list = Common.get_text_by_class_name(self, ClassName.ivu_btn_long, "button")
        self.assertTrue(Common.check_text_in_list(self, text_list, "登录"))
