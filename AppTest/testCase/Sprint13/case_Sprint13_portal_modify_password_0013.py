...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_element(self, psd_ele[0], Content.login_password)
        Common.send_text_by_element(self, psd_ele[1], Content.login_password)
        Common.touch_by_id(self, ID.pwdFormOkBtn)

        logger.info("查看是否修改成功")
        tip = Common.get_text_by_class_name(self, ClassName.tit, "span")
        self.assertTrue(Common.check_text_in_list(self, tip, "密码修改成功"))
