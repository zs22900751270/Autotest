...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入密码", "111111")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "确认密码", "111111")
        ...
        logger.info("只输入新密码，点击确定")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入密码", "aaaaaa")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "确认密码", "aaaaaa")
        Common.touch_by_id(self, ID.updatePasswordBtn)
