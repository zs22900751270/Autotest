...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        ident_code = Common.get_identifying_code(self, Content.no_register_count)
        for i in range(11):
            Common.wait(self, 30)
            Common.touch_by_element(self, input_ele[1])
        Common.send_text_by_element(self, input_ele[1], ident_code)
        ...
        self.assertTrue(Common.check_text_in_list(self, err_tip, "验证码已失效,请重新获取"))
