...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("点击删除")
        Common.touch_del_or_edit_by_sechedule_name(self, "schedule_11", "delete")

        logger.info("判断是否删除成功")
        sechdule_list = Common.get_elements_by_class_name_and_text(self, "div", ClassName.schedule_item_name_ivu_col_span_14,
                                                                   "schedule_11")
        self.assertTrue(len(sechdule_list) == 0)
