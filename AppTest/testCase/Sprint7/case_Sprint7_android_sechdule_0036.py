...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("创建无备注日程")
        BaseOperate.creat_schedule(self, "11111111", "11111111")
        BaseOperate.creat_schedule(self, "qweqewrwer", "qweqewrwer")
        BaseOperate.creat_schedule(self, "!@###@@@@", "!@###@@@@")
        BaseOperate.creat_schedule(self, "www.baidu.com", "www.baidu.com")
        ...
        res4 = BaseOperate.check_text_in_list(self, content_list, "www.baidu.com")
