...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("创建日程")
        Common.creat_schedule(self, "schedule_1")

        logger.info("判断是否创建成功")
        schedule_list = Common.get_results_by_class_name_blank(self, ClassName.schedule_item, "div")
        self.assertIsNotNone(schedule_list)
