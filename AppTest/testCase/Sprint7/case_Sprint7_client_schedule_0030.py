...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("修改日程提醒")
        Common.touch_text_by_class_name(self, ClassName.ivu_select_selected_value, "不重复", "span")
        Common.touch_text_by_class_name(self, ClassName.ivu_select_item, "每天", "li")
        ...
        res1 = Common.check_text_in_list(self, sechdule_list, "每天")
        self.assertTrue(res1)
