...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        end_t = Common.get_mission_end_time(self)
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请选择结束时间", end_t)
        ...
        res1 = Common.check_text_in_list(self, sechdule_list, end_t[-8:-4])
        self.assertTrue(res1)
