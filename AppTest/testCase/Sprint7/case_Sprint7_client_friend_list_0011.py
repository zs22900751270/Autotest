...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("判断添加好友输入框的最长输入值")
        ele = Common.get_element_by_placeholder_and_class_name(self, ClassName.ivu_input, "请输入电话号码搜索")
        maxlen = ele.get_attribute("maxlength")
        self.assertEqual(maxlen, "11")
