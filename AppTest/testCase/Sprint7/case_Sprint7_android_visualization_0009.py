...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("从常用移除")
        BaseOperate.touch_text_by_class_name(self, PhoneControl.class_name_TextView, "常用模板")
        BaseOperate.touch_id_by_index(self, PhoneControl.id_oper)

        logger.info("判断是否移除成功")
        result = BaseOperate.checkIfIdExist(self, PhoneControl.id_oper)
