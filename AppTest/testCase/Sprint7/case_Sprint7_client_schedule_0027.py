...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("修改日程开始时间")
        start_t = Common.get_mission_start_time(self)
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请选择开始时间", start_t)
        ...
        res1 = Common.check_text_in_list(self, sechdule_list, start_t[-8:-4])
        self.assertTrue(res1)
