...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("在web界面点击设为常用")
        BaseOperate.touch_text_by_class_name(self, PhoneControl.class_name_TextView, "设为常用")

        logger.info("判断设置成功")
        result = BaseOperate.checkIfIdExist(self, PhoneControl.id_common)
