...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("点击添加模板")
        tr = Common.get_result_by_class_name_blank(self, "div", ClassName.ivu_tabs_tab)
        Common.touch_by_element(self, tr)
        ...
        logger.info("点击删除模板")
        tr1 = Common.get_result_by_class_name_blank(self, "div", ClassName.ivu_tabs_tab)
        Common.touch_by_element(self, tr1)
        item_results1 = Common.get_results_by_class_name_blank(self, "div", ClassName.tpl_item)
        Common.move_mouse_on(self, item_results1[0])
        settings_item1 = Common.get_results_by_class_name_blank(self, "i", ClassName.fa_trash_o)
        Common.touch_by_element(self, settings_item1[0])

        logger.info("判断是否移除成功")
