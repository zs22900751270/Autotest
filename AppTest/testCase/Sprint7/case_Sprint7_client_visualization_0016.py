...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("从常用模板进入全部模板")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn, "添加常用", "button")

        logger.info("判断是否进入全部模板界面")
        text = Common.get_text_by_class_name(self, ClassName.ivu_tabs_tab_active_focused, "div")[0]
        self.assertEqual(text, "所有模版")
