...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("修改任务内容")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入任务内容", "new_mission")
        ...
        res = Common.check_text_in_list(self, task_name_list, "new_mission")
        self.assertTrue(res)
