...
remarks = "1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111" \
...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("输入备注")
        BaseOperate.sendTextById(self, PhoneControl.id_remark, remarks)

        logger.info("判断备注长度")
        bz = BaseOperate.get_text_by_id(self, PhoneControl.id_remark)
        self.assertEqual(len(bz), 200)
        self.assertTrue(len(remarks) > 200)
