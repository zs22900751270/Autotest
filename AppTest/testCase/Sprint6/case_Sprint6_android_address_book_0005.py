...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("判断是否进入界面")
        BaseOperate.touch_text_by_class_name(self, PhoneControl.class_name_TextView, friend_name)
        self.assertEqual(BaseOperate.get_text_by_id(self, PhoneControl.id_toolbar_title_tv), "好友资料")
