...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        BaseOperate.sendTextById(self, PhoneControl.id_remark, "friend_info")
        BaseOperate.touch_id_by_index(self, PhoneControl.id_toolbar_right_tv)
        ...
        logger.info("判断是否获取到好友请求备注信息")
        BaseOperate.touch_id_by_index(self, PhoneControl.id_new_friend)
        friend_info = BaseOperate.get_text_list_by_id(self, PhoneControl.id_contact_item_remark)
        self.assertTrue("friend_info" in friend_info)
