...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.touch_id_by_element(self, ID.deleteRoleGroupBtn, name_list)

        logger.info("查看是否有弹框提示")
        self.assertTrue(Common.check_if_class_name_exist(self, ClassName.ivu_btn_large, "button"))
