...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.touch_text_by_class_name(self, ClassName.ivu_vtn_warn_small, "设置角色", "button", 1)

        logger.info("查看是否进入设置职位界面")
        text_list = Common.get_text_by_class_name(self, ClassName.ivu_modal_header)
        self.assertTrue(Common.check_text_in_list(self, text_list, "设置角色"))
