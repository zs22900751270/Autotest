...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue(Common.check_text_in_list(self, text_list, "请输入角色名称"))
        self.assertTrue(Common.check_text_in_list(self, text_list, "请输入角色描述"))

        logger.info("创建新角色不输入描述")
        ...
        text_list = Common.get_text_by_class_name(self, ClassName.ivu_form_item_error_tip, "div")
        self.assertTrue(Common.check_text_in_list(self, text_list, "请输入角色名称"))
        self.assertFalse(Common.check_text_in_list(self, text_list, "请输入角色描述"))
