...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("查看是否有长度输入限制")
        input_ele = Common.get_element_by_placeholder_and_class_name(self, ClassName.ivu_input, "请输入职位")
        self.assertEqual(input_ele.get_attribute("maxlength"), "50")
