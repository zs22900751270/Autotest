...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        Common.delete_role_group_by_name(self, "new_role")
        Common.quit(self)
    ...
    def test_step(self):
        ...
        Common.touch_by_id(self, ID.addRoleBtn, 5)
        ...
        logger.info("点击编辑角色名称")
        Common.touch_text_by_class_name(self, ClassName.ivu_menu_item, "zs_role", "li")
        Common.touch_by_id(self, ID.editRoleBtn)
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "角色名称", "new_role")
        Common.touch_by_id(self, ID.addRoleBtn)

        logger.info("查看是否编辑成功")
        name_list = Common.get_element_by_class_name_and_text(self, "div", ClassName.ivu_menu_submenu_title, "zs_group")
        fol = Common.get_class_name_elements_by_element_blank(self, name_list, "i", ClassName.ivu_icon_ios_folder)
        Common.touch_by_element(self, fol[0])
        role_name = Common.get_text_by_class_name(self, ClassName.ivu_menu_item, "li")
        Common.touch_text_by_class_name(self, ClassName.ivu_menu_item, "new_role", "li")
        self.assertTrue(Common.check_text_in_list(self, role_name, "new_role"))

        logger.info("点击修改描述")
        Common.touch_by_id(self, ID.editRoleBtn)
        ele_input = Common.get_result_by_class_name_blank(self, "textarea", ClassName.ivu_input)
        Common.send_text_by_element(self, ele_input, "new_describe")
        Common.touch_by_id(self, ID.addRoleBtn)
        ...
        Common.touch_by_element(self, fol[0])
        Common.touch_text_by_class_name(self, ClassName.ivu_menu_item, "new_role", "li")
        text_list = Common.get_text_by_class_name(self, ClassName.desc, "div")
        self.assertTrue(Common.check_text_in_list(self, text_list, "new_describe"))

        logger.info("点击切换角色组")
        Common.touch_by_id(self, ID.editRoleBtn)
        Common.touch_text_by_class_name(self, ClassName.ivu_select_selected_value, "zs_group", "span")
        Common.touch_text_by_class_name(self, ClassName.ivu_select_item, "其他", "li")
        Common.touch_by_id(self, ID.addRoleBtn)

        logger.info("查看是否编辑成功")
        name_list = Common.get_element_by_class_name_and_text(self, "div", ClassName.ivu_menu_submenu_title, "其他")
        fol = Common.get_class_name_elements_by_element_blank(self, name_list, "i", ClassName.ivu_icon_ios_folder)
        Common.touch_by_element(self, fol[0])
        Common.touch_text_by_class_name(self, ClassName.ivu_menu_item, "new_role", "li")
        self.assertTrue(Common.check_text_in_list(self, role_name, "new_role"))
