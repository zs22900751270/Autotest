...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        Common.delete_department_by_name(self, "son_department")
    ...
    def test_step(self):
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入部门名称", "son_department")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_large, "确定", "button")
        Common.touch_text_by_class_name(self, ClassName.name, "zs_test", "span")

        logger.info("点击解散部门, 查看是否可以删除")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_warning, "解散部门", "button")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_large, "确定", "button")
        tip_list = Common.get_text_by_class_name(self, ClassName.sweet_alert_showsweetalert_visible, "div")
        self.assertTrue(Common.check_text_in_list(self, tip_list, "请先删除子部门"))
