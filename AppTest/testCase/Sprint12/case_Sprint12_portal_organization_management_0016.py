...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue(Common.check_text_in_list(self, err_list, "请输入职位"))

        logger.info("只输入职位点击保存")
        Common.clear_text_by_class_name_and_placeholder(self, ClassName.ivu_input, "请输入手机号码")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入职位", "new_zhi_wei")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_large, "确定", "button")
        err_list = Common.get_text_by_class_name(self, ClassName.ivu_form_item_error_tip, "div")
        self.assertTrue(Common.check_text_in_list(self, err_list, "请输入手机号码"))
