...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("查看备注")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_ghost_small, "查看备注", "button")
        text_list = Common.get_text_by_class_name(self, ClassName.ivu_poptip_body_content_inner, "div")
        self.assertTrue(Common.check_text_in_list(self, text_list, "qi_yong"))
