...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue(Common.check_text_in_list(self, tip_list, "电话号码无效"))
        Common.touch_text_by_class_name(self, ClassName.confirm, "OK", "button")
