...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_element(self, input_list[0], Content.register_count)
        Common.send_text_by_element(self, input_list[1], Content.spare_password)
        ...
        self.assertTrue(Common.check_text_in_list(self, err_list, "两次输入的密码不一样!"))
