...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_element(self, input_list[1], Content.register_count)
        ...
        self.assertTrue(Common.check_text_in_list(self, err_list, "请输入密码"))
