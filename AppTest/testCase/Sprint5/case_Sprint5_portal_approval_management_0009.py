...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue(len(created_approval_name) == 1)

        logger.info("删除该分组")
        Common.del_group_by_name(self, group_name)

        logger.info("该分组中的审批是否移动至其他")
        Common.check_approval_in_group(self, approval_name, "其他")
