...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.creat_meeting(self, "meeting_no_sign", name=real_name)
        ...
        start_time, end_time = Common.get_start_and_end_time(self, type="hour", time_len=2)
        Common.modify_meeting_time(self, start_time, end_time, "meeting_no_sign", Content.register_count)
        ...
        logger.info("选择其中一个会议不参加")
        Common.open_meeting_detail_by_name(self, "meeting_no_sign", 1)
        ...
        self.assertTrue(Common.check_meeting_belong_to(self, "meeting_cancel", 2))
        self.assertTrue(Common.check_meeting_belong_to(self, "meeting_over", 2))
        self.assertTrue(Common.check_meeting_belong_to(self, "meeting_no_sign", 2))
