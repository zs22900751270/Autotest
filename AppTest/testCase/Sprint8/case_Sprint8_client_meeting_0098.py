...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.clear_text_by_class_name_and_placeholder(self, ClassName.ivu_input, "请输入会议主题")
        ...
        self.assertTrue(Common.check_text_in_list(self, err_list, "请填写会议主题"))
