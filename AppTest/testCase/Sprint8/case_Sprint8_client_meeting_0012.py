...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入会议主题", "new_theme")
        ...
        self.assertTrue(Common.check_meeting_belong_to(self, "new_theme", 1))
