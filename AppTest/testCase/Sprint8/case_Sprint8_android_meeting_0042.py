...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("会议已删除")
        new_title_name = BaseOperate.get_text_list_by_id(self, PhoneControl.id_title)
        check_tit_res = BaseOperate.check_text_in_list(self, new_title_name, "meeting_test")
        self.assertFalse(check_tit_res)
