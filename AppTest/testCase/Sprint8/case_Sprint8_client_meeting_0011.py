...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("判断各项按钮都存在")
        self.assertTrue(Common.check_if_id_exist(self, ID.openCancelModelBtn))
        self.assertTrue(Common.check_if_id_exist(self, ID.editMeetingBtn))
        self.assertTrue(Common.check_if_id_exist(self, ID.addPersonBtn))
