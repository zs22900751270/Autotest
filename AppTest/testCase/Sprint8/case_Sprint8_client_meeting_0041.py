...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("判断会议是否会同时出现在未结束与已结束列表中")
        self.assertTrue(Common.check_meeting_belong_to(self, "meeting_theme", 1))
        self.assertFalse(Common.check_meeting_belong_to(self, "meeting_theme", 2))
        ...
        logger.info("判断会议是否会同时出现在未结束与已结束列表中")
        self.assertFalse(Common.check_meeting_belong_to(self, "meeting_theme", 1))
