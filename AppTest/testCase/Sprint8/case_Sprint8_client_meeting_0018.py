...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        start_time, end_time = Common.get_start_and_end_time(self, time_len=20)
        ...
        logger.info("出现不可点击的签到按钮")
        sign_btn = Common.get_result_by_class_name_blank(self, "button", ClassName.disable_btn_ivu_text)
        logger.info(Common.get_text_by_element(self, sign_btn))
        self.assertEqual(Common.get_text_by_element(self, sign_btn), "会议签到")
