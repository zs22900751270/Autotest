...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        BaseOperate.creat_file_in_android(self, file_name_txt, folder_name, "cheng_xin")
        ...
        BaseOperate.touch_text_by_class_name(self, PhoneControl.class_name_TextView, "下载")
