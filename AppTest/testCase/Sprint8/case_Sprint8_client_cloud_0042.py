...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("上传大小为101M的文件")
        Cloud.upload_file(self, "file_name_101M", 1024*1024*101, 5)

        logger.info("弹出提示空间不够")
        notice = Common.get_text_by_class_name(self, ClassName.sweet_alert_showsweetalert_visible, "div")
        self.assertTrue(Common.check_text_in_list(self, notice, "云盘剩余空间不足"))
