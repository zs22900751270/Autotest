...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        check_1 = BaseOperate.checkIfIdExist(self, PhoneControl.id_title)
        self.assertTrue(check_1)
        tit_text = BaseOperate.get_text_by_id(self, PhoneControl.id_title)
        self.assertEqual(tit_text, "meeting_test1")
