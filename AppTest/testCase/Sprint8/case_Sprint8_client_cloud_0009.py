...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Cloud.creat_folder(self, "folder_name_2")

        logger.info("进入其中一个文件夹")
        Cloud.open_folder_by_name(self, "folder_name_1")

        logger.info("点击创建文件夹")
        Cloud.creat_folder(self, "folder_name_2")

        logger.info("查看创建是否成功")
        self.assertTrue(Cloud.check_if_file_exist(self, "folder_name_2"))
