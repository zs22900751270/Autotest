...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("点击参会人头像")
        ul_res = Common.get_result_by_class_name_blank(self, "ul", ClassName.con)
        Common.touch_tag_name_by_element(self, ul_res, "img")

        logger.info("判断是否进入好友资料详情界面")
        self.assertTrue(Common.check_if_id_exist(self, ID.friendDetail))
