...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        met_the = Common.get_element_by_placeholder_and_class_name(self, ClassName.ivu_input, "请输入会议内容")
        self.assertEqual(met_the.get_attribute("maxlength"), "200")
