...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        u"""android—参与人点击不参加会议，需要填写原因系统会通知创建者"""
