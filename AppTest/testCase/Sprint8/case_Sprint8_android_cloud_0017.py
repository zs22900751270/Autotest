...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        BaseOperate.touch_text_by_id(self, "test_zs", PhoneControl.id_name)
        ...
        self.assertTrue(BaseOperate.check_text_in_list(self, name_list, "zs_test"))
        self.assertTrue(BaseOperate.check_text_in_list(self, name_list, "zhangsen_file"))
