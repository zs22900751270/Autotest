...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("搜索文件")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入文件名称", "folder_name_12\n")

        logger.info("查看是否搜扫到文件")
        id_result_list = Common.get_results_by_id(self, ID.currentRow)
        self.assertTrue(len(id_result_list), 1)
