...
my_folder_name_new = "new_zs_test"
...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        BaseOperate.sendTextById(self, PhoneControl.id_remark, my_folder_name_new)
        BaseOperate.touch_id_by_index(self, PhoneControl.id_toolbar_right_tv)
        logger.info("判断是否修改文件名成功")
        name_list_1 = BaseOperate.get_text_list_by_id(self, PhoneControl.id_name)
        self.assertTrue(BaseOperate.check_text_in_list(self, name_list_1, my_folder_name_new))
