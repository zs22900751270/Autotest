...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Mail_phone.send_mail(self, Content.spare_mail_address, "mail_theme_2", mail_content="456")
        Mail_phone.send_mail(self, Content.spare_mail_address, "mail_theme_3", mail_content="789")

        logger.info("进入发件箱")
        BaseOperate.touch_id_by_index(self, PhoneControl.id_send_box)
        logger.info("查看邮件排序，以及参数是否显示正常")
        ...
        BaseOperate.touch_text_by_id(self, "mail_theme_2", PhoneControl.id_theme)
        tit_text = BaseOperate.get_text_by_id(self, PhoneControl.id_toolbar_title_tv)
        self.assertEqual(tit_text, "邮件详情")
        BaseOperate.go_back(self)
        BaseOperate.touch_text_by_id(self, "mail_theme_3", PhoneControl.id_theme)
        tit_text = BaseOperate.get_text_by_id(self, PhoneControl.id_toolbar_title_tv)
        self.assertEqual(tit_text, "邮件详情")
