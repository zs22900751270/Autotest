...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue(Mail_phone.check_mail_if_exist_by_theme(self, "mail_theme_2"))
        self.assertTrue(Mail_phone.check_mail_if_exist_by_theme(self, "mail_theme_3"))
