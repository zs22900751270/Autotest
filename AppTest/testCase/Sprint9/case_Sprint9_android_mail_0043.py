...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue(BaseOperate.checkIfIdExist(self, PhoneControl.id_star))
        self.assertTrue(BaseOperate.checkIfIdExist(self, PhoneControl.id_reply))
        self.assertTrue(BaseOperate.checkIfIdExist(self, PhoneControl.id_forward))
        self.assertTrue(BaseOperate.checkIfIdExist(self, PhoneControl.id_reply_all))
