...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        BaseOperate.creat_file_from_window_to_android(self, file_name, folder_name, 105904176)
