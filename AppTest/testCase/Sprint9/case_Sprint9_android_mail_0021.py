...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("发送邮件")
        Mail_phone.send_mail(self, Content.spare_mail_address, "http://www.baidu.com/")
        ...
        self.assertTrue(Mail_phone.check_mail_if_exist_by_theme(self, "http://www.baidu.com/"))
