...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("判断会议排序是否变化")
        theme_list1 = BaseOperate.get_text_list_by_id(self, PhoneControl.id_theme)
        self.assertEqual(theme_list1[0], "meeting_test2")
        self.assertEqual(theme_list1[1], "meeting_test3")
        self.assertEqual(theme_list1[2], "meeting_test1")
