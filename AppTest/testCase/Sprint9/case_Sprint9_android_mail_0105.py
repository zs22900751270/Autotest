...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue(BaseOperate.checkIfIdExist(self, PhoneControl.id_send))
        ...
        text_list = BaseOperate.get_text_list_by_id(self, PhoneControl.id_theme)
        self.assertFalse(BaseOperate.check_text_in_list(self, text_list, "mail_theme_1"))
