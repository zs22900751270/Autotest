...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("发送邮件")
        BaseOperate.creat_file_from_window_to_android(self, mail_file, folder_name, 1024)
        Mail_phone.send_mail(self, Content.spare_mail_address, "mail_theme_1", file_name=mail_file,
