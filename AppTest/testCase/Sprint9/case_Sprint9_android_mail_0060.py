...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertEqual(len(BaseOperate.get_text_list_by_id(self, PhoneControl.id_theme)), 1)
        self.assertEqual(BaseOperate.get_text_by_id(self, PhoneControl.id_theme), "mail_theme_1")
