...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        # 输入特殊字符的密码
        BaseOperate.sendTextById(self, PhoneControl.forget_input_password, "zs123456@#!")
        # 再次输入该密码
        BaseOperate.sendTextById(self, PhoneControl.forget_input_password_again, "zs123456@#!")
