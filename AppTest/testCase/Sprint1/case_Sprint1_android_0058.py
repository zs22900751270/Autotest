...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        # 输入新密码
        BaseOperate.sendTextById(self, PhoneControl.forget_input_password, "1234qwerrewq4321")
        # 重复输入密码（两次输入不同密码）
        BaseOperate.sendTextById(self, PhoneControl.forget_input_password_again, "1234qwerrewq4321")
        # 点击下一步
