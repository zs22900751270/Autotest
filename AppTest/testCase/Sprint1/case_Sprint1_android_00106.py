...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        # 输入验证码
        BaseOperate.sendTextById(self, "com.hqd.app_manager:id/verify_code_edit", identify_code)
        BaseOperate.input_text_by_cmd(self, "321")
        # 点击下一步
        get_input_identify = BaseOperate.get_text_by_id(self, "com.hqd.app_manager:id/verify_code_edit")
        self.assertTrue(len(get_input_identify) == 6)
        self.assertTrue(get_input_identify == identify_code)
