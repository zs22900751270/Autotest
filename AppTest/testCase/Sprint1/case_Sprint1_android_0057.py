...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        # 输入新密码
        BaseOperate.sendTextById(self, PhoneControl.forget_input_password, "qqqq!@#1111")
        # 重复输入密码（两次输入不同密码）
        BaseOperate.sendTextById(self, PhoneControl.forget_input_password_again, "qqqq!@#1111")
        # 点击下一步
        text = BaseOperate.get_text_by_id(self, PhoneControl.id_password_warning_tv)
        # 提示密码不符合要求
        self.assertTrue(text == "请输入数字字母组合")
