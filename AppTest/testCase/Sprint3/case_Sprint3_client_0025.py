...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        logger.info("第二次输入错误的验证码")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入验证码", " 123 456")
        logger.info("点击注册")
        Common.touch_by_id(self, ID.registerBtn)
        result = Common.get_text_by_class_name(self, ClassName.ivu_form_item_error_tip, "div")
        self.assertTrue(BaseOperate.check_text_in_list(self, result, "请输入6位数字验证码"))

        logger.info("第三次输入错误的验证码")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入验证码", " 123456 ")
        logger.info("点击注册")
        Common.touch_by_id(self, ID.registerBtn)
        result = Common.get_text_by_class_name(self, ClassName.ivu_form_item_error_tip, "div")
