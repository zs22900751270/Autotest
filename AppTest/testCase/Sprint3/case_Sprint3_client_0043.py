...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "设置常用手机号为登录账号",
                                                       "012345678912")
        Common.wait(self, 3)
        input_result = Common.get_element_by_placeholder_and_class_name(self, ClassName.ivu_input,
                                                                        "设置常用手机号为登录账号")
        input_result = input_result.get_attribute("maxlength")
        self.assertEqual(input_result, "11")

        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "设置常用手机号为登录账号", "01234567")
