...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入企业服务电话", "000")
        ...
        self.assertTrue("请输入正确电话(xxx-xxxxxxxx|xxxx-xxxxxxx|11位手机号)" in get_phone_error)
