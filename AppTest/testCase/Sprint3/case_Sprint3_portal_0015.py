...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        self.assertTrue("请选择主题" in error_list)
        self.assertTrue("请输入库名称" in error_list)
        self.assertTrue("请输入表名称" in error_list)
        self.assertTrue("请输入字段名称" in error_list)
        self.assertTrue("请输入字段说明" in error_list)
        self.assertTrue("请输入字段含义" in error_list)
        self.assertTrue("请选择字段类型" in error_list)
        self.assertTrue("请选择" in error_list)
