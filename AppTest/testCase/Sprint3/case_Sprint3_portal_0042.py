...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        for i in range(11):
            ...
            logger.info("输入应用名称")
            Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入应用名称", "app_name%s" % i)
            ...
            Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入应用详情链接",
                                                           "http://www.baidu.com")
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "输入应用名称、ISV名称进行搜索", "app_name10")
