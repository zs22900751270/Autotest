...
class MyTestCase(unittest.TestCase):
    ...
    def phone(self):
        try:
            ...
            BaseOperate.touchById(self, PhoneControl.me)
            BaseOperate.touchById(self, PhoneControl.login_or_register)
            BaseOperate.touchById(self, PhoneControl.register_button)
            BaseOperate.sendTextById(self, PhoneControl.register_phone_num, Content.no_register_count)
            BaseOperate.touchById(self, PhoneControl.register_verify_button)
            get_ident_phone = BaseOperate.get_identifying_code(self, Content.no_register_count)
            BaseOperate.sendTextById(self, PhoneControl.register_verify_input, get_ident_phone)
            BaseOperate.touchById(self, PhoneControl.register_next_button)
            BaseOperate.touchById(self, PhoneControl.id_user_agreement_text)
            BaseOperate.wait(self, 20)
