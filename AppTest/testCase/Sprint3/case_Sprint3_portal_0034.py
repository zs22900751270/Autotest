...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "输入应用名称、ISV名称进行搜索", "app_name")
        ...
        logger.info("删除所创建的数据")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_small, "删除", "button")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_large, "确定", "button")

        logger.info("检测是否删除成功")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "输入应用名称、ISV名称进行搜索", "app_name")
        Common.touch_search_by_placeholder(self, "输入应用名称、ISV名称进行搜索")
        search_result = Common.get_results_by_class_name_blank(self, "tr", ClassName.ivu_table_row)
