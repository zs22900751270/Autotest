...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        Common.del_app_entity_by_name(self, "123321")
        Common.quit(self)
    ...
    def test_step(self):
        ...
        logger.info("输入应用名称")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入应用名称", "123321")
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "输入应用名称、ISV名称进行搜索", "123321")
