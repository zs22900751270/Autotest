...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "请输入字段名称", "new_name_str")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_large, "确定", "button")

        logger.info("通过搜索，确定修改成功")
        Common.send_text_by_class_name_and_palceholder(self, ClassName.ivu_input, "字段名称", "new_name_str\n")
