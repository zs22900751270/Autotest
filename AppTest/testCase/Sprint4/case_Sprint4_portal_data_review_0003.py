...
class MyTestCase(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Common.touch_class_name_by_name(self, data_table_name, "button", ClassName.ivu_btn_primary_small)

        logger.info("判断数据显示情况")
        info_ele = Common.get_results_by_class_name_blank(self, "div", ClassName.ivu_table_cell)
        self.assertEqual(len(info_ele)-3, 3)
