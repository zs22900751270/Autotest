...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        logger.info("收尾工作")
        Common.connect_sql(self, "delete from report_template where tpl_name='%s'" % template_name, "scap")
        # Common.quit(self)
    ...
    def test_step(self):
        ...
        logger.info("点击保存")
        Common.touch_text_by_class_name(self, ClassName.ivu_btn_primary, "保存模版", "button")
